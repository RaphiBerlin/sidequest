      ...
      {step === 'email' ? (
        ...
        <form onSubmit={verifyOtp} className="w-full max-w-sm flex flex-col gap-4">
          ...
          <input
            ...
            className="bg-transparent border-b border-paper/40 text-paper placeholder-paper/20 py-2 text-4xl text-center tracking-[0.6em] outline-none focus:border-paper transition-colors"
          />
